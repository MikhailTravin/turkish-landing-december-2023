(() => {
    ...
    document.addEventListener("DOMContentLoaded", (() => {
        const newYear = new Date("Dec 31 2024 00:00:00");
        ...
        const timeCount = () => {
            ...
            let days = normalize(Math.floor(leftUntil / 1e3 / 60 / 60 / 24));
            let hours = normalize(Math.floor(leftUntil / 1e3 / 60 / 60) % 24);
            let minutes = normalize(Math.floor(leftUntil / 1e3 / 60) % 60);
